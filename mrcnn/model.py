...
def compute_backbone_shapes(config, image_shape):
    ...
    assert config.BACKBONE in ["resnet50", "resnet101", "resnet152", "densenet121", "densenet169", "densenet201"]
    return np.array(
...
def resnet_graph(input_image, architecture, stage5=False, train_bn=True):
    """Build a ResNet graph.
        architecture: Can be resnet50 or resnet101 or resnet152
...
def dense_graph(input_image, architecture, blocks, growth_rate, compression=0.5, use_bias=False, train_bn=True):
    """
    :param input_image:
    :param architecture:
    :param blocks:
